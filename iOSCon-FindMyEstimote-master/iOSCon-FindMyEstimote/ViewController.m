...
{
    self.seekbutton.center = CGPointMake(self.seekbutton.center.x, self.seekbutton.center.y - 1111);
    self.howToPlayButton.center = CGPointMake(self.howToPlayButton.center.x - 500, self.howToPlayButton.center.y - 0);
